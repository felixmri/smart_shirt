...
r1_ch1, r1_ch2 = read_data('data3/ds1.csv', normalize=True)
r2_ch1, r2_ch2 = read_data('data3/ds2.csv', normalize=True)
r3_ch1, r3_ch2 = read_data('data3/ds3.csv', normalize=True)
r4_ch1, r4_ch2 = read_data('data3/ds4.csv', normalize=True)
r5_ch1, r5_ch2 = read_data('data3/ds5.csv', normalize=True)
r6_ch1, r6_ch2 = read_data('data3/ds6.csv', normalize=True)
r7_ch1, r7_ch2 = read_data('data3/ds7.csv', normalize=True)
r8_ch1, r8_ch2 = read_data('data3/ds8.csv', normalize=True)

r9_ch1, r9_ch2 = read_data('data3/ds9.csv', normalize=True)
r10_ch1, r10_ch2 = read_data('data3/ds10.csv', normalize=True)
r11_ch1, r11_ch2 = read_data('data3/ds11.csv', normalize=True)
r12_ch1, r12_ch2 = read_data('data3/ds12.csv', normalize=True)
r13_ch1, r13_ch2 = read_data('data3/ds13.csv', normalize=True)
r14_ch1, r14_ch2 = read_data('data3/ds14.csv', normalize=True)
r15_ch1, r15_ch2 = read_data('data3/ds15.csv', normalize=True)
r16_ch1, r16_ch2 = read_data('data3/ds16.csv', normalize=True)
# plot
plot_data(r1_ch1, r1_ch2, 'DS 1')
plot_data(r2_ch1, r2_ch2, 'DS 2')
plot_data(r3_ch1, r3_ch2, 'DS 3')
plot_data(r4_ch1, r4_ch2, 'DS 4')
plot_data(r5_ch1, r5_ch2, 'DS 5')
plot_data(r6_ch1, r6_ch2, 'DS 6')
plot_data(r7_ch1, r7_ch2, 'DS 7')
plot_data(r8_ch1, r8_ch2, 'DS 8')

plot_data(r9_ch1, r9_ch2, 'DS 9')
plot_data(r10_ch1, r10_ch2, 'DS 10')
plot_data(r11_ch1, r11_ch2, 'DS 11')
plot_data(r12_ch1, r12_ch2, 'DS 12')
plot_data(r13_ch1, r13_ch2, 'DS 13')
plot_data(r14_ch1, r14_ch2, 'DS 14')
plot_data(r15_ch1, r15_ch2, 'DS 15')
plot_data(r16_ch1, r16_ch2, 'DS 16')
